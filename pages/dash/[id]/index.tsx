...
const getPages = (props) => {
    ...
    return {
        ...
        CUSTOMERS: <CustomersPage user={user} program={program} customers={customers} />,
                ...
                <div className="h-screen col-span-1 bg-white shadow">
                    <div className="grid grid-rows-1 p-8 gap-y-6">
                        <div className="flex flex-col p-2 bg-gray-100 rounded shadow">
                            ...
                            <a className="mt-3 font-medium text-red-500 hover:underline hover:text-red-600" href={program.qrcode} download>Download QRCode</a>
                        </div>
